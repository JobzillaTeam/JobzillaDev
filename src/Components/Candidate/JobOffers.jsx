        ...
        <section class="content_section">
          <div class="row">
            <div class="col-md-12 py-4">
              ...
              <p class="job-invite mb-0">You have {cloneResourceJobs && cloneResourceJobs.length ? cloneResourceJobs.length : 0} job offers</p>
            </div>
          </div>
                    ...
                    return (
                      <div class="jobListItem">
                        <section class={`row mx-0 px-4 ${resourceIndex !== 0 && 'pt-4'} pb-4`}>
                          ...
                          <div class="col-12 px-0 text-right marB10"><Link to={{ pathname: `/candidate/jobDetails/jobOffers/${jobDetails.jobId}` }}>view details <img src="/images/icons/view_details_arrow.svg" class="detail-arrow" /></Link></div>
                        </section>
                      </div>
                    )
                  }) : null
