        ...
        <section class="content_section">
          <div class="row">
            <div class="col-md-12 pb-2 pt-2">
              ...
              <p class="job-invite">You have {inviteJobs && inviteJobs.length ? inviteJobs.length : 0} invites, View <span class="job-accepted"><Link to="/candidate/Interviews/AcceptedInterviews" class="job-accept">Accepted interviews</Link></span></p>
            </div>
          </div>
