...
const SearchJobsDetails = (props) => {
  const jobID = props.match.params.jobID;
  const isBottomActionButtonsVisible = true;
  ...
  const handleStatusUpdate = (e, isAccepted) => {
    ...
    new ApiServicesOrg().updateApplicationStatus(jobID, candidateId, 'Application_Sent_By_Candidate')
      .then(Response => {
        ...
        if (applicationStatus === 'Application_Sent_By_Candidate') setIsActionButtonsVisible(false);
      })
  }
  return (
    <Fragment>
            ...
            <div className="card content_card">
              <div className="card-body">
                ...
                {isActionButtonsVisible && <div className="action_buttons">
                  <button type="button" className="btn btn-primary" onClick={e => handleStatusUpdate(e, true)}>Apply</button>
                  <button type="button" className="btn btn-outline-primary ml-4" onClick={e => handleStatusUpdate(e, false)}>Cancel</button>
                </div>}
