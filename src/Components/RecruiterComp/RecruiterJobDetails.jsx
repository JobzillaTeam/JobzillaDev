...
export default class RecruiterJobDetails extends React.Component {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    const jobStatus = this.props.match.params.jobStatus;
    let perviousLink = '';
    let perviousLinkText = '';
    switch (jobStatus) {
      case 'active': {
        perviousLink = '/activeJob';
        perviousLinkText = 'Active Jobs';
      }
        break;
      case 'closed': {
        perviousLink = '/closeJobs';
        perviousLinkText = 'Closed Jobs';
      }
        break;
    }
    return (
            ...
            {jobDetails && <div>
              ...
              <div>
                {jobStatus === 'active' ?
                  ...
                  // </div>
                  : jobStatus === 'closed' ? <ClosedJobCandidates joinedCandidates={[]} /> : undefined}
              </div>
            </div>
