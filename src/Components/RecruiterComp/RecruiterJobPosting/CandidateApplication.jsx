...
export default class CandidateApplication extends Component {
    ...
    componentDidMount() {
        ...
        //Api call for candidate application
    ...
    //Api call for changing application status-on click of accept
    ...
    //Api call for changing application status-on click of decline
