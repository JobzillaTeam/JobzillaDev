...
export default class ShortlistedCandidate extends Component {
    ...
    loadMore() {
        setTimeout(()=>{
        if(this.state.candidate1.length>=1000){
        ...
        return (
            <div>
                ...
                <InfiniteScroll
                    ...
                    next={this.loadMore}
                    hasMore={this.state.candidate1.length>=this.state.visible}
                    loader={<RenderLoader />}
                    height={450}
                            ...
                            <table className="table table-borderless custom-table ">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                    <Link to= {`/candidateProfileToOpen/${data.candidate.candidateId}`} onClick={() => this.showProfile(data.candidate.candidateId)}><p className="tb-title-text">{data.candidate.firstName} {data.candidate.lastName}</p> </Link>
