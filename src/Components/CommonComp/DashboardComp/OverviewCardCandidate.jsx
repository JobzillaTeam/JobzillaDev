                            ...
                            <div className="media">
                                ...
                                <div className="media-body">
                                    <h5 className="mt-0 overview_numbers">
                                        <CountUp start={0} end={Number(jobsApplied)} duration={2.75} separator="," />
                                    </h5>
                                    Jobs Applied
                                </div>
                            </div>
                    ...
                    <div className="col-12 col-sm-12 col-md-6 col-lg-4">
                        <section className="activeJobs_section_Card">
                            <div className="media">
                                ...
                                <div className="media-body">
                                    <h5 className="mt-0 overview_numbers">
                                        <CountUp start={0} end={Number(selectedForInterviews)} duration={2.75} separator="," />
                                    </h5>
                    ...
                    <div className="col-12 col-sm-12 col-md-6 col-lg-4">
                        <section className="candidateHired_section_Card">
                            <div className="media">
                                ...
                                <div className="media-body">
                                    <h5 className="mt-0 overview_numbers">
                                        <CountUp start={0} end={Number(jobOffers)} duration={2.75} separator="," />
                                    </h5>
                            Job Offers
                                </div>
                            </div>
