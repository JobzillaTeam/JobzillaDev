  ...
  render() {
    ...
    const getPath = (jobId, applicationStatus) => {
      if (!applicationStatus) {
        return ({
          pathname: `/candidate/jobDetails/recentMatches/${jobId}/?isFreshJob=true`,
          isFreshJob: true
        })
      } else {
                ...
                return (
                  <div key={index} className="row align-items-center">
                    ...
                    <div className={"col-12 col-sm-12 col-md-4 col-lg-4 d-flex flex-row-reverse align-items-center"}>
                      <div className="p-2 ml-3"><Link to={getPath(data.jobId, data.applicationStatus)}><span className="mr-2">View Details</span><i className="fa fa-angle-right mr-2" aria-hidden="true"></i></Link></div>
                      <div className="p-2">
